            ...
            <div>
                <AnimateInView>
                    ...
                    <Text fz={isMobile ? "xs" : "sm"} c="darkColor" mb="xl" pb={isMobile ? "5rem" : "10rem"}>
                        This project is still ongoing. I&apos;ve designed mockups in Figma and implemented some of it in code using Makerkit. Feel free to check out the marketing website <a href="https://www.credtent.org/" target="_blank" rel="noopener noreferrer">here</a>.
                    </Text>
                </AnimateInView>
            </div>
        </div>
